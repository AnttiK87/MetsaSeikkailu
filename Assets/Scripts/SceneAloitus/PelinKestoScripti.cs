...
public class PelinKestoScripti : MonoBehaviour // scripti joka laskee pelin keston
{
    ...
    public void VaaraVastausNappiaPainaessa(Button painettuNappi) // jos painetaan väärää vastausnappia, lisätään aikaa 5 sek timeriin
    {
    ...
    public void LisaaAikaa() // lisää aikaa
    {
        if (ajastinKaynnissa)
        {
            aloitusaika -= 5; // vähennetään 5 sekunttia aloitusajasta
            Debug.Log("5 sekunttia lisätty timeriin"); // debuggausta varten
        }
    }
